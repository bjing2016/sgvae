# from https://github.com/dmlc/dgl/blob/master/examples/pytorch/model_zoo/chem/generative_models/dgmg/utils.py
...
def download_data(dataset, fname):
    ...
    data_path = fname
    download("http://s3.us-east-2.amazonaws.com/dgl.ai/dataset/ChEMBL_DGMG_train.txt", path=data_path)
